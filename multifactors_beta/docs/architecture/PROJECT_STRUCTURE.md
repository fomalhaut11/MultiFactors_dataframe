...
│       │   ├── incremental_financial_updater.py # 增量财务更新
│       │   └── incremental_stop_price_updater.py # 增量停牌价格更新
│       ├── processor/               # 数据处理管道
│       │   ├── data_processing_pipeline.py # 主处理流水线
│       │   ├── enhanced_pipeline.py        # 增强处理流水线
│       │   ├── financial_processor.py      # 财务数据处理器
│       │   ├── price_processor.py          # 价格数据处理器
│       │   └── return_calculator.py        # 收益计算器
│       ├── examples/                # 数据格式示例
│       │   └── data_format_examples.py
│       ├── schemas.py               # 数据结构定义
...
│       │   └── validation.py        # 验证工具
│       ├── backtest_api_design.py   # API设计文档
│       └── backtest_usage_guide.md  # 使用指南
│
├── 🧪 测试框架
│   └── tests/                       # 统一测试框架
│       ├── README.md                # 测试说明
...
│       │   ├── test_data_processor_consistency.py # 数据处理一致性测试
...
├── 📚 示例和文档
│   ├── examples/                    # 使用示例
│   │   ├── factor_calculation_example.py   # 因子计算示例
│   │   ├── data_adapter_example.py  # 数据适配器示例
│   │   └── utils_usage_example.py   # 工具使用示例
│   │
│   └── docs/                        # 详细文档
│       ├── README.md                # 文档目录
│       ├── BP因子使用指南.md         # BP因子使用指南
│       ├── 因子计算模块迁移指南.md    # 迁移指南
│       ├── 数据预处理功能完整指南.md  # 数据预处理指南
│       └── Price数据增量更新使用说明.md # 数据更新说明
│
├── 🔧 工具和调试
│   ├── tools/                       # 开发工具
