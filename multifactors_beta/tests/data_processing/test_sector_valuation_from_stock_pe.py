...
from data.processor.sector_valuation_from_stock_pe import SectorValuationFromStockPE
...
def test_sector_valuation():
    ...
    if output_path.exists():
        files = list(output_path.glob("sector_valuation_from_stock_pe*"))
        if files:
            print(f"\n输出文件:")
            for f in files:
